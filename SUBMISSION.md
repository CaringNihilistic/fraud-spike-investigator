...
| **Same recipe on REAL data** (ULB, 284k txns, 0.173% fraud) | **PR-AUC 0.731** vs 0.0017 random baseline (423x lift) |
...
**23 logged failures** in `CLAUDE.md`, every one caught by measuring a claim rather than re-reading code. The seven that matter most:
