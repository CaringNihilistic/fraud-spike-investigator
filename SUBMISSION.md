...
| **Engineering** | **130 tests**, no network or credentials needed · one-command demo · **38 logged entries** with root causes |
...
One command runs it: `python run_demo.py` (trains, serves, replays 14,160 transactions through the real pipeline). **130 tests pass with no network and no credentials.**
