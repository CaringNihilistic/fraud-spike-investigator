...
**What we therefore claim, and nothing more:** public data validates the *transaction-risk* component. The *merchant-level* entity-resolution layer is evaluated on controlled scenarios, because no public dataset we could find reproduces the persistent account/device/IP relationships it operates on.
